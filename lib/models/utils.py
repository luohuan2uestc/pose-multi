...
def efficientnet_lite_params(model_name):
    """ Map EfficientNet Lite model name to parameter coefficients. """
    params_dict = {
        # Coefficients:   width,depth,res,dropout
...
def efficientnet_lite(width_coefficient=None, depth_coefficient=None, dropout_rate=0.2,
                 drop_connect_rate=0.2, image_size=None, num_classes=1000):
    """ 
    Creates a efficientnet_lite model without se. 
    """

    blocks_args = [
        'r1_k3_s11_e1_i32_o16_se2', 'r2_k3_s22_e6_i16_o24_se2',
        'r2_k5_s22_e6_i24_o40_se2', 'r3_k3_s22_e6_i40_o80_se2',
        'r3_k5_s11_e6_i80_o112_se2', 'r4_k5_s22_e6_i112_o192_se2',
        'r1_k3_s11_e6_i192_o320_se2',
    ]
    blocks_args = BlockDecoder.decode(blocks_args)
